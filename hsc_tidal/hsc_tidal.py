...
# TODO(hsc_tidal): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
"""

# TODO(hsc_tidal): BibTeX citation
_CITATION = """
"""
...
class HscTidal(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for hsc_tidal dataset."""
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    catalog_path = dl_manager.download('https://storage.googleapis.com/ml22/hsc_photoz/data/Tidal1.fits')
    cutouts_path = dl_manager.download('https://storage.googleapis.com/ml22/hsc_photoz/data/Tidal_cutout.hdf')
    return [
